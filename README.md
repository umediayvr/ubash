...
C) Deploying under the production area and making it available right away in new sessions (means the version is going to be available for users having the UBASH_VERSION containing the release type getting deployed):
```bash
